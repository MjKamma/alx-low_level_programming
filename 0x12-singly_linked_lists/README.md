This project is all about Singly linked lists in C programming Language.
...
File lists.h is the header file containing the definition of the list_t struct and all the prototypes of the functions used on this project.
